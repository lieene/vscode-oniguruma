...
const oniguru_node_path = vscode.env.npm  + '\\node_modules.asar.unpacked\\oniguruma\\build\\Release\\onig_scanner.node'

const OnigScanner = require(oniguru_node_path).OnigScanner
const OnigString = require(oniguru_node_path).OnigString
